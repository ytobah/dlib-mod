...
//                        sum_n_free += df(i); //ORIG
            ...
            scalar_type r1,r2;
            if(num_p_free > 0){
//                r1 = sum_p_free/num_p_free; //ORIG
//               printf("r1: %f\n",r1);

               // printf("sum_p_free is: ");
               // cout << typeid(sum_p_free).name() << endl;
               // printf("num_p_free is: "); 
               // cout << typeid(num_p_free).name() << endl;
               // printf("r1 is: "); 
...
//                r1 = (upper_bound_p+lower_bound_p)/2; //ORIG

               // printf("upper_bound_p is: ");
               // cout << typeid(upper_bound_p).name() << endl;
...
//                cout << typeid(sum_n_free).name() << endl;
//                printf("num_n_free is: "); 
//                cout << typeid(num_n_free).name() << endl;
//                printf("r2 is: "); 
